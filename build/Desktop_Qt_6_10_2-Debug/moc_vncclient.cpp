...
template <> constexpr inline auto VncClient::qt_create_metaobjectdata<qt_meta_tag_ZN9VncClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'serverNotReachable'
        QtMocHelpers::SignalData<void(const QString &, int, const QString &)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 12 }, { QMetaType::Int, 13 }, { QMetaType::QString, 14 },
        }}),
    };
...
void VncClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->serverNotReachable((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[3]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (VncClient::*)(const QString & )>(_a, &VncClient::clipboardTextReceived, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (VncClient::*)(const QString & , int , const QString & )>(_a, &VncClient::serverNotReachable, 5))
            return;
    }
}
...
// SIGNAL 5
void VncClient::serverNotReachable(const QString & _t1, int _t2, const QString & _t3)
{
